  ...
  const handleSendNotification = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (recipient === "production-team") {
        ...
        recipients = ["production-team-id", "quality-manager-id", "lab-manager-id"]
      }
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Send and receive notifications related to laboratory tests and quality control.
        </p>
      </div>
      {hasError && (
          ...
          <Card>
            <form onSubmit={handleSendNotification}>
              <CardHeader>
                ...
                <CardDescription>Send notifications to production team or management.</CardDescription>
              </CardHeader>
