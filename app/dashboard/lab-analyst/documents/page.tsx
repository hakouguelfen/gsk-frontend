    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          View and print Corrective and Preventive Action (CAPA) instructions.
        </p>
      </div>
      ...
      <Tabs defaultValue="assigned" className="space-y-4">
        ...
        <TabsContent value="assigned">
          ...
          ) : assignedCAPAs.length === 0 ? (
            <div className="flex items-center justify-center h-40 bg-gray-50 rounded-md">
              <p className="text-muted-foreground">
                No CAPA documents assigned to you
              </p>
            </div>
          ) : (
                  ...
                  <CardHeader>
                    ...
                    <CardDescription>
                      <div className="flex items-center gap-2">
                        ...
                        >
                          {capa.priority.charAt(0).toUpperCase() +
                            capa.priority.slice(1)}{" "}
                          Priority
                        </Badge>
                        <span className="text-xs">
                          Assigned:{" "}
                          {capa.createdAt?.toDate().toLocaleDateString()}
                        </span>
                      </div>
                    </CardDescription>
                  </CardHeader>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          size="sm"
                          variant="outline"
                          onClick={() => capa.id && handlePrint(capa.id)}
                        >
        ...
        <TabsContent value="all">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                View all available CAPA documents in the system.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex items-center justify-center h-40 bg-gray-50 rounded-md">
                <p className="text-muted-foreground">
                  All CAPA documents will be displayed here
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value="archived">
          <Card>
            ...
            <CardContent>
              <div className="flex items-center justify-center h-40 bg-gray-50 rounded-md">
                <p className="text-muted-foreground">
                  Archived CAPA documents will be displayed here
                </p>
              </div>
            </CardContent>
          </Card>
