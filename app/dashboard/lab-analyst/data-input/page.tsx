...
function DataInputForm() {
  ...
  const [selectedProcess, setSelectedProcess] =
    useState<FabricationProcess | null>(null);
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      setFabricationProcesses((prev) =>
        prev.filter((p) => p.id !== selectedProcess.id),
      );
    } catch (error) {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Enter HPLC analysis data for fabricated batches.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter the HPLC analysis parameters for the selected batch.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
                    ...
                    <FormItem>
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="Condectivite">
                            conductivité
                          </SelectItem>
                          <SelectItem value="Impurite">Impureté</SelectItem>
                        </SelectContent>
                      </Select>
                      <FormMessage />
                    </FormItem>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Details of the selected fabrication batch.
            </CardDescription>
          </CardHeader>
          <CardContent>
            {selectedProcess ? (
              <div className="space-y-6">
                ...
                <div className="flex justify-center">
                  <div className="relative w-48 h-48 rounded-lg overflow-hidden border-2 border-gray-200">
                    <Image
                      src={
                        getProductImage(selectedProcess.product_name) ||
                        "/placeholder.svg"
                      }
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Badge
                      variant={
                        selectedProcess.isFabricated ? "default" : "secondary"
                      }
                    >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Badge
                      variant={
                        selectedProcess.isTested ? "default" : "destructive"
                      }
                    >
                      {selectedProcess.isTested ? (
                        <CheckCircle className="w-3 h-3 mr-1" />
                      ) : (
              ...
              <div className="flex flex-col items-center justify-center h-96 text-center">
                ...
                <p className="text-sm text-gray-400 max-w-sm">
                  Please select a batch ID from the dropdown to view fabrication
                  details and enter analysis data.
                </p>
              </div>
            )}
          </CardContent>
